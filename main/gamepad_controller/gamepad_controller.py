...
log = Logger().setup_logger('Gamepad controller')
...
class GamepadController:
    ...
    def do_process_events_from_queues(self):
        ...
        while True:
            if self.connected_device and not gamepad_controller_connected_already:
    ...
    def check_for_connected_devices(self):
        ...
        connected_device = Config().get(Config.GAMEPAD_CONTROLLER_DEVICE)

        log.info('The gamepad controller is not detected, looking for connected devices')
        self.connected_device = False
